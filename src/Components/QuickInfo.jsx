...
const QuickInfo = () => {
  return (
<div data-aos="fade" data-aos-once="true" data-aos-delay="300" className='w-full flex justify-between md:justify-around text-white !px-8 !mt-8 md:!my-12 xl:hidden lg:!my-0'>
